...
<div class='form col-md-6 col-lg-6'>
	<fieldset>
		<legend> <img style="border-radius:100%; width:50px;"src="/public/backdoor/uploads/logo/sonarbangla.png"/> </legend>
			<form method='post' action="{{route('videoAddConfirm')}}" enctype='multipart/form-data'>
			    @csrf
				<table border='0' cellpadding='12' cellspacing='0'>
					...
					<tr>
					    <td> Details </td>
						<td> <input type='text' class="form-control"  autofocus  required name='details' placeholder='Enter Name'/></td>
					</tr>					
					<tr>
						<td> video link </td>
						<td> <input type='text'class="form-control"   autofocus  required name='location' onchange=loadFile(event) placeholder='Enter Name'/></td>
					</tr>
    					<!--<tr>-->
    					<!--    	<td>  </td>-->
