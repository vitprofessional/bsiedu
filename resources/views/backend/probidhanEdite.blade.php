...
<div class='form col-md-6 col-lg-6'>
	...
	<fieldset>
		<legend> <img style="border-radius:100%; width:50px;"src="/public/backdoor/uploads/logo/sonarbangla.png"/> </legend>
			<form method='post' action="{{route('updateProbidhan')}}" enctype='multipart/form-data'>
			    <input type="hidden" name="id" value="{{ $Datakey->id }}"  />
			    @csrf
				<table border='0' cellpadding='12' cellspacing='0'>
					<tr>
						<td> Probidhan </td>
						<td> <input type='text' class="form-control" autofocus  required name='probidhan' value="{{ $Datakey->probidhan }}" placeholder='Enter Name'/></td>
					</tr>
					<tr>
						<td> Department </td>
						<td>
