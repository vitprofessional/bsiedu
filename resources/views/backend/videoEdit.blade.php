...
<div class='form col-md-6 col-lg-6'>
	...
	<fieldset>
		<legend> <img style="border-radius:100%; width:50px;"src="/public/backdoor/uploads/logo/sonarbangla.png"/> </legend>
			<form method='post' action="{{route('videoAddUpdate')}}" enctype='multipart/form-data'>
				...
				<table border='0' cellpadding='12' cellspacing='0'>
					...
					<tr>
						<td> image </td>
						<td> <input type='text'class="form-control" value="{{ $Datakey->location }}"  autofocus  required name='avatar' onchange=loadFile(event) placeholder='Enter Name'/></td>
					</tr>
					<!--<tr>-->
					<!--    <td>  </td>-->
					...
					<!--    <td> <iframe src="{{ asset('/').$Datakey->location }}" style="width:200px; height:100px;" frameborder="0"> </iframe></td> -->
					<!--</tr>					-->
					<tr>
							<td>  </td>
