                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Ex-principal</h5>
                        </div>
                        ...
                        @endif
                        <div class="card-body">
                             <a class="btn btn-danger btn-sm  m-2" href="{{ route('NewExprincipal') }}">Add New</a>
                                        ...
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item remove-item-btn" href="{{ route('EditeExprincpal',['id'=>$glry->id]) }}">
                                      ...
                                      <div class="modal-dialog">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="{{route('ExprincipalDelete',['id'=>$glry->id])}}"  type="button" class="btn btn-primary">Yes</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>                                    
