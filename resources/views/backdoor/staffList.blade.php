                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0 fw-bold">Employees Panel</h5>
                        </div>
                        <div class="card-body">
                            ...
                            @endif 
                             <a class="btn btn-danger btn-sm  m-2" href="{{ route('newProfile',['profileType'=>'Employee']) }}">New Profile</a>
                            <table data-order='[[ 1, "desc" ]]' data-page-length='20' id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('/') }}public/storage/frontend/uploads/staff/{{ $stf->avatar }}" class="img-fluid rounded w-50" alt="{{ $stf->name }}" />
                                        </td>
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item remove-item-btn" href="{{ route('editProfile',['profileType'=>'Employee','id'=>$stf->id]) }}">
                                      ...
                                      <div class="modal-dialog">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="{{route('delProfile',['profileType'=>'Employee','id'=>$stf->id])}}"  type="button" class="btn btn-primary">Yes</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>                                     
