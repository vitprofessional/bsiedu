...
Create Inhouse Training(Staffs)
@endsection
        ...
        <div class="container-fluid"> <!-- coustom image -->
            <div class="row">
                <div class="col-md-6 m-auto">
                    <div class="card">
                        <div class="card-header"> <h3>Create Inhouse Training(Staffs)</h3> </div>
                        <div class="card-body">
                            ...
                            @endif  
                            <form class="form text-danger font-weight-bold" action="{{ route('createInHouseStaff') }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}     
