                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Addmission information</h5>
                        </div>
                        ...
                        @endif
                        <div class="card-body">
                             <a class="btn btn-danger btn-sm  m-2" href="{{ route('NewInstitutedetails') }}">Add New</a>
                            <table data-order='[[ 1, "desc" ]]' data-page-length='20' id="example" class=" text-center table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                             <a data-fancybox data-type="iframe"  style="width:300px;"  href="{{url('/')."/".$glry->avatar}}"   target="_blank"><i data-feather="eye"></i></a>
                                        ...
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item remove-item-btn" href="{{ route('EditeinstituteDetails',['id'=>$glry->id]) }}">
                                      ...
                                      <div class="modal-dialog">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="{{route('instituteDelete',['id'=>$glry->id])}}"  type="button" class="btn btn-primary">Yes</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>                                    
