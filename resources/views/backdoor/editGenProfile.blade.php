            ...
            <div class="row">
                <div class="col-12 col-md-10 mx-auto">
                    <div class="card card-default">
                        <div class="card-header">Update Employee Profile</div>
                        <div class="card-body">
                            ...
                            @endif
                            <form class="form row" method="POST" action="{{ route('saveEmployee') }}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="employeeId" value="{{ $employee->id }}">
                                ...
                                <div class="form-group my-2">
                                    ...
                                    <a class="btn btn-primary btn-sm  m-2" href="{{ route('teacherPanel') }}">All Employee</a>
                            ...
                            <a class="btn btn-success btn-sm  m-2" href="{{ route('teacherPanel') }}">All Employee</a>
                            <a class="btn btn-info btn-sm  m-2" href="{{ route('newEmployeeProfile') }}">Create New Profile</a>
                            @endif
                        </div>
                    </div>
