...
<div class="row">
                <div class="col-md-6 m-auto">
                    <div class="card">
                        <div class="card-header"> <h3>Sylabus Existing </h3> </div>
                        <div class="card-body">
                            ...
                            @endif  
                            <form class="form text-danger font-weight-bold" action="{{ route('juniorStaffStore') }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}                        
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="degination" placeholder="Enter your phone">
                                    </div>                                      
