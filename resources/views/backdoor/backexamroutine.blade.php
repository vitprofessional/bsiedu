                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Class Rotine Datatables</h5>
                        </div>
                        ...
                        @endif
                        <div class="card-body">
                             <a class="btn btn-danger btn-sm  m-2" href="{{ route('newexamroutine') }}">Add New</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            ...
                                            <td>{{$sp->status}}</td>
                                            <td>
                                                <a data-fancybox data-type="iframe" class="pl-0" href="{{ asset('/') }}{{$sp->avatar }}" title=" {{ $sp->department }}">
                                                    <span>
                                            ...
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item remove-item-btn" href="{{ route('editExamRoutine',['id'=>$sp->id]) }}">
                                      ...
                                      <div class="modal-dialog">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="{{route('delExamRoutine',['id'=>$sp->id])}}"  type="button" class="btn btn-primary">Yes</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>                                      
