                ...
                <div class="col-12 col-md-10 mx-auto">
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            ...
                            @endif 
                            @if(!empty($industry))
                            <form class="form row" method="POST" action="{{ route('updateIndustryLinkage') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="col-12 col-md-6 my-2">
                                    ...
                                    @if(!empty($industry->companyLogo))
                                    <div class="form-group my-2">
                                        <lable for="avatar">Company Picture</lable>
                                        @php
                                            $extension = pathinfo(asset('storage/app/public/frontend/uploads/industry').'/'.$industry->companyLogo, PATHINFO_EXTENSION);
                                        @endphp
                                        @if($extension == 'pdf' || $extension == 'PDF')
                                        <iframe class="w-100 mb-4" src="{{ asset('storage/app/public/frontend/uploads/industry').'/'.$industry->companyLogo }}" alt="{!! $industry->name !!}" style="width:100%;height:170px !important"></iframe>
                                        @else
                                        <img class="w-100 mb-4" src="{{ asset('storage/app/public/frontend/uploads/industry').'/'.$industry->companyLogo }}" alt="{!! $industry->name !!}">
                                        @endif
                                        <a href="{{ route('delIndustryCompany',['id'=>$industry->id]) }}">Delete</a>
                                    </div>
                                    @else
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group my-2">
                                        ...
                                        <input type="text" class="form-control" name="contactPerson" value="{{ $industry->contactPerson }}" placeholder="Enter contact person name" required>
                                    </div>
                                    <div class="form-group my-2">
                                    ...
                                    @if(!empty($industry->mouSign))
                                    <div class="form-group my-2">
                                        <lable for="mouSign">MOU Sign</lable>
                                        @php
                                            $extension = pathinfo(asset('storage/app/public/frontend/uploads/industry').'/'.$industry->mouSign, PATHINFO_EXTENSION);
                                        @endphp
                                        @if($extension == 'pdf' || $extension == 'PDF')
                                        <iframe class="w-100 mb-4" src="{{ asset('storage/app/public/frontend/uploads/industry').'/'.$industry->mouSign }}" alt="{!! $industry->name !!}" style="width:100%;height:170px !important"></iframe>
                                        @else
                                        <img class="w-100 mb-4" src="{{ asset('storage/app/public/frontend/uploads/industry').'/'.$industry->mouSign }}" alt="{!! $industry->name !!}">
                                        @endif
                                        <a href="{{ route('delIndustryMou',['id'=>$industry->id]) }}">Delete</a>
                                    </div>
                                    @else
