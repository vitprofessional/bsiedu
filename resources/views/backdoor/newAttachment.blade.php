            ...
            <div class="row">
                <div class="col-12 col-md-10 mx-auto">
                    <div class="card card-default">
                        <div class="card-header fw-bold">Create New Attachment</div>
                        <div class="card-body">
                            ...
                            @endif 
                            <form class="form row" method="POST" action="{{ route('saveAttachment') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="form-group my-2">
                                        ...
                                        <input type="text" class="form-control" name="toDate" placeholder="Example: 10/12/2022" required>
                                    </div>
                                </div>
                                <div class="form-group my-2">
