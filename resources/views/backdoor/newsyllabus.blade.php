        ...
        <div class="container-fluid"> <!-- coustom image -->
            <div class="row">
                <div class="col-md-6 m-auto">
                    <div class="card">
                        <div class="card-header"> <h3>Sylabus Management </h3> </div>
                        <div class="card-body">
                            ...
                            @endif  
                            <form class="form text-danger font-weight-bold" action="{{ route('createsyllabus') }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}                        
                                    <div class="form-group">
                                        <lable for="probidhan">Probidhan</lable>
                                        <input class="form-control" type="text" name="probidhan" placeholder="Enter probidhan name">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="semister" placeholder="Enter semister name">
                                    </div>
                                    <div class="form-group">
