                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Lab info</h5>
                        </div>
                        <div class="card-body">
                             <a class="btn btn-danger btn-sm  m-2" href="{{ route('labAddView') }}">Add New </a>
                            <table data-order='[[ 1, "desc" ]]' data-page-length='20' id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ $stf->image1 }}" class="img-fluid rounded"style="width:70px; height:70px;" alt="{{ $stf->name }}" alt="image"/>
                                        </td>
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li><a class="dropdown-item edit-item-btn"  data-bs-toggle="modal" data-bs-target="#exampleModal{{$stf->id}}" href="{{ route('deletelab',['id'=>$stf->id]) }}"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Delete</a></li>
                                                    <li>
                                      ...
                                      <div class="modal-dialog">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="{{route('deletelab',['id'=>$stf->id])}}"  type="button" class="btn btn-primary">Yes</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>                                     
