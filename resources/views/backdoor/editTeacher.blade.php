                ...
                <div class="col-12 col-md-10 mx-auto">
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            ...
                            @endif 
                            @if(!empty($staff))
                            <form class="form row" method="POST" action="{{ route('updateTeacherPic') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-4 col-md-2 my-2 mx-auto">
                                    <div class="form-group my-2">
                                        ...
                                        <div class="mt-1">
                                            <a href="{{ route('delTeacherPic',['id'=>$staff->id]) }}" class="btn btn-danger btn-sm w-100">Delete</a>
                                        </div>
                                    </div>
                                @else
                            ...
                            <form class="form row" method="POST" action="{{ route('updateTeacher') }}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="profileId" value="{{ $staff->id }}">
                                <input type="hidden" name="profileType" value="{{ $profileType }}">
                                ...
                                <div class="form-group my-2">
                                    ...
                                    <a class="btn btn-danger btn-sm  m-2" href="{{ route('newTeacherProfile') }}">Create New Profile</a>
                                </div>
                            </form>
                            @else
                            ...
                            <a class="btn btn-info btn-sm  m-2" href="{{ route('newTeacherProfile') }}">Create New Profile</a>
                            @endif
                        </div>
                    </div>
                </div>
