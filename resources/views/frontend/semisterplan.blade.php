...
<div class="row">
    ...
    <div class="col-md-12 pt-0 pr-2 pl-2 pb-2">
        ...
        <div class="card">
            ...
            <div class="card-body radius-" style="background-color: #fff;">
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @php
                                if(count($semisterplan)>0):
                                    $x=1;
                                    foreach($semisterplan as $pro):
                            @endphp
                            <tr>
                                <td>{{ $x }}</td>
                                ...
                                <td>{{ $pro->semister }}</td>
                                <td>{{ $pro->subject }}</td>
                                <td><a data-fancybox data-type="iframe" href="{{ asset('/') }}public/storage/frontend/uploads/semisterplan/{{ $pro->avatar }}" title=" {{ $pro->probidhan }}" class="text-light pl-0" style="text-decoration: none;">
                            <span>
