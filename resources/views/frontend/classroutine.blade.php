                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $pro->semister }}</td>
                                <td>{{ $pro->shift }}</td>
                                <td><a data-fancybox data-type="iframe" href="{{ asset('/') }}public/storage/frontend/uploads/classroutine/{{ $pro->avatar }}" title=" {{ $pro->probidhan }}" class="text-light pl-0" style="text-decoration: none;">
                            <span>
