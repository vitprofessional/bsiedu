                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $pro->semister }}</td>
                                <td>{{ $pro->probidhan }}</td>
                                <td><a data-fancybox data-type="iframe" href="{{ asset('/') }}public/storage/frontend/uploads/syllabus/{{ $pro->avatar }}" title=" {{ $pro->probidhan }}" class="text-light pl-0" style="text-decoration: none;">
                            <span>
