...
@section('backtitle') Contact page @endsection
@section('backcontent')
<style>
body {
   ...
   <div class="container">
       <div calss="row text-center">
        ...
        <div class='row'>
            ...
            @endif            
            <form    method="post" id="myForm" action="{{route('contactStore')}}" enctype="multipart/form-data"> 
            <div class="row">
               <div class="col-md-6">
                        @csrf
               ...
               <div class="row">
                   <div class="col-md-3">
                       <button style="margin-bottom:20px; " type="submit" class="btn btn-primary btn-block "> Submit </button>
                   </div>                   
               </div>
            </div>
            </form>             
